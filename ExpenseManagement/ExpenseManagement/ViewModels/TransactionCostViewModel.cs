...
{
    public class TransactionCostViewModel : BaseViewModel
    {
        ...
        public TransactionCostViewModel()
        {
            Title = "Transaction";
        ...
        async Task ExecuteLoadItemsCommand()
        {
            ...
            try
            {
                ...
                var transactionList = await typesServices.GetAllTransaction(typeConst.Cost, idUser);
